import { a8 as Buffer, a1 as getDefaultExportFromCjs } from "./index.es-C5h6IJQJ.js";
...
(function(exports) {
  ...
  exports.swap32IfBE = exports.isLE ? (u2) => u2 : byteSwap32;
  const hasHexBuiltin2 = /* @__PURE__ */ (() => (
    // @ts-ignore
...
class SHA256 extends HashMD {
  ...
  get() {
    const { A: A2, B: B2, C: C2, D: D2, E: E2, F: F2, G: G2, H } = this;
    return [A2, B2, C2, D2, E2, F2, G2, H];
  }
  // prettier-ignore
  set(A2, B2, C2, D2, E2, F2, G2, H) {
    this.A = A2 | 0;
    this.B = B2 | 0;
    this.C = C2 | 0;
    this.D = D2 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A2, B: B2, C: C2, D: D2, E: E2, F: F2, G: G2, H } = this;
    for (let i2 = 0; i2 < 64; i2++) {
      const sigma1 = rotr(E2, 6) ^ rotr(E2, 11) ^ rotr(E2, 25);
      const T1 = H + sigma1 + Chi(E2, F2, G2) + SHA256_K[i2] + SHA256_W[i2] | 0;
    ...
    G2 = G2 + this.G | 0;
    H = H + this.H | 0;
    this.set(A2, B2, C2, D2, E2, F2, G2, H);
  }
  roundClean() {
    clean(SHA256_W);
  }
...
//# sourceMappingURL=index-CGlhbQtC.js.map
